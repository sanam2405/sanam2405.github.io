...
// Add new images to the floatingImages array
floatingImages.push({
...
floatingImages.push({
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-22'),
    image: document.getElementById('floating-image-22'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-23'),
    image: document.getElementById('floating-image-23'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-24'),
    image: document.getElementById('floating-image-24'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-25'),
    image: document.getElementById('floating-image-25'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-26'),
    image: document.getElementById('floating-image-26'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-27'),
    image: document.getElementById('floating-image-27'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-28'),
    image: document.getElementById('floating-image-28'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-29'),
    image: document.getElementById('floating-image-29'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-30'),
    image: document.getElementById('floating-image-30'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-31'),
    image: document.getElementById('floating-image-31'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-32'),
    image: document.getElementById('floating-image-32'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-33'),
    image: document.getElementById('floating-image-33'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-34'),
    image: document.getElementById('floating-image-34'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-35'),
    image: document.getElementById('floating-image-35'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-36'),
    image: document.getElementById('floating-image-36'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
  ...
  floatingImages.push({
    container: document.getElementById('floating-image-container-37'),
    image: document.getElementById('floating-image-37'),
    lastTime: 0,
    x: Math.random() * window.innerWidth,
    y: Math.random() * window.innerHeight,
    angle: Math.random() * 360
...
function moveImages(currentTime) {
    floatingImages.forEach((image) => {
      ...
      if (image.x > window.innerWidth || image.y > window.innerHeight) {
        ...
        image.container.style.opacity = '0';
